...
(function (stringArrayFunction, comparisonValue) {
  ...
  while (!![]) {
    try {
      const expression = -parseInt(__DECODE_0__(0x1cb)) / 0x1 + parseInt(__DECODE_0__(0x1bf)) / 0x2 + -parseInt(__DECODE_0__(0x1be)) / 0x3 * (-parseInt(__DECODE_0__(0x1c3)) / 0x4) + -parseInt(__DECODE_0__(0x1c4)) / 0x5 * (parseInt(__DECODE_0__(0x1c0)) / 0x6) + -parseInt(__DECODE_0__(0x1c7)) / 0x7 + -parseInt(__DECODE_0__(0x1c5)) / 0x8 + parseInt(__DECODE_0__(0x1c1)) / 0x9;
...
function Main(input) {
  const setting = input[__DECODE_0__(0x1c2)]()[__DECODE_0__(0x1ca)]('\x0a');
  const process_sum = setting[0x0] - 0x0;
  const up = setting[0x1]['split']('\x20');
  const down = setting[0x2][__DECODE_0__(0x1ca)]('\x20');
  let answer = 0x0;
...
Main(require('fs')[__DECODE_0__(0x1c9)](__DECODE_0__(0x1c6), __DECODE_0__(0x1c8)));
